    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[3000] flex items-center justify-center p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
                ...
                <div className="p-4 sm:p-8 overflow-y-auto print:p-0 print:overflow-visible text-gray-800 bg-white">
                    <div className="border-b-2 border-slate-200 pb-6 mb-6 flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4">
                        <div>
