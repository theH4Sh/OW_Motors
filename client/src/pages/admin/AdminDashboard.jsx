                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                        <div className="kpi-card">
                            ...
                            <div className="kpi-body">
                                ...
                                <p className="kpi-value text-emerald-600">
                                    <span className="kpi-currency">PKR</span>
                        ...
                        <div className="kpi-card">
                            ...
                            <div className="kpi-body">
                                ...
                                <p className="kpi-value text-rose-600">
                                    <span className="kpi-currency">PKR</span>
                        ...
                        <div className="kpi-card">
                            ...
                            <div className="kpi-body">
                                ...
                                <p className="kpi-value text-[#0B7C56]">
                                    <span className="kpi-currency">PKR</span>
                        ...
                        <div className="kpi-card">
                            ...
                            <div className="kpi-body">
                                ...
                                <p className="kpi-value">{totalOrders.toLocaleString()}</p>
                            </div>
                        </div>
                        <div className="kpi-card">
                            ...
                            <div className="kpi-body">
                                ...
                                <p className="kpi-value">{totalManagers.toLocaleString()}</p>
                            </div>
                        </div>
                        <div className="kpi-card">
                            ...
                            <div className="kpi-body">
                                ...
                                <p className="kpi-value">{totalProducts.toLocaleString()}</p>
                            </div>
                        </div>
                        <div className="kpi-card">
                            ...
                            <div className="kpi-body">
                                ...
                                <p className="kpi-value">{totalUnits.toLocaleString()}</p>
                            </div>
                        </div>
                        <div className="kpi-card">
